...
import { LayoutDashboard, UserCircle, MapPin, MessageSquare, LogOut, Users, Menu, MessageCircle, Puzzle, Gift, BarChart3 } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/rifa", label: "Gestión de Rifa", icon: Gift },
